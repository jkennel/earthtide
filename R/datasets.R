...
# @keywords internal
#
# @references Hartmann, T., Wenzel, H.-G., 1995. The HW95 tidal potential
#  catalogue. Geophys. Res. Lett. 22, 3553-3556. \doi{10.1029/95GL03324}
#
# @examples
# hw95s
# 'hw95s'
...
# }
#
# @references Kudryavtsev, S.M., 2004. Improved harmonic development of the
#  Earth tide-generating potential. J. Geod. 77, 829-838.
...
#  \item{\code{t4}}{t4}
# }
# @references Simon JL, Bretagnon P, Chapront J, Chapront-Touzè M, Francou G,
